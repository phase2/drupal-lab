# Pattern Lab Standard Edition for Drupal [DEVELOPER PREVIEW]
...
The Standard Edition for Drupal comes with the following components:
...
There are two methods for downloading and installing the Standard Edition for Drupal:
...
The fastest way to get started with the Standard Edition for Drupal is to [download the pre-built version](https://github.com/pattern-lab/edition-php-drupal-standard/releases) from the [releases page](https://github.com/pattern-lab/edition-php-drupal-standard/releases). The pre-built project comes with the [Base StarterKit for Drupal](https://github.com/pattern-lab/starterkit-drupal-base) installed by default.

**Please note:** Pattern Lab uses [Composer](https://getcomposer.org/) to manage project dependencies. To upgrade the Standard Edition for Drupal or to install plug-ins you'll need to [install Composer](https://getcomposer.org/doc/00-intro.md#installation-linux-unix-osx). We recommend that you [install it globally](https://getcomposer.org/doc/00-intro.md#globally).
...
#### 2. Install the Standard Edition for Drupal

Use Composer's [`create-project` command](https://getcomposer.org/doc/03-cli.md#create-project) to install the Standard Edition for Drupal into a location of your choosing. In Terminal type:

    cd install/location/
    composer create-project pattern-lab/edition-drupal-standard your-project-name && cd $_

This will install the Standard Edition for Drupal into a directory called `your-project-name` in `install/location/`. During the set-up process you will be asked to install an appropriate StarterKit. You will be automatically dropped into the project directory after the process is finished.
